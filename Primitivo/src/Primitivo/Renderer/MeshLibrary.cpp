...
#include "Primitivo/FunctionsLibraries/StringOperations.h"
...
namespace Primitivo {
	...
	AssetRef<VertexArray>& MeshLibrary::Load(const std::string& name, const std::string& filePath) {
		...
		Primitivo::BufferLayout triangleLayout = {
			{Primitivo::ShaderDataType::Float3, "a_Position"},
			{Primitivo::ShaderDataType::Float2, "a_Texcoord"},
			{Primitivo::ShaderDataType::Float3, "a_Normal"}
