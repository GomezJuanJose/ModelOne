...
PFNGLPrimitivoRESTARTINDEXPROC glad_glPrimitivoRestartIndex = NULL;
...
static void load_GL_VERSION_3_1(GLADloadproc load) {
	...
	glad_glPrimitivoRestartIndex = (PFNGLPrimitivoRESTARTINDEXPROC)load("glPrimitivoRestartIndex");
