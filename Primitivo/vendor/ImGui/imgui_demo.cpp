...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Rendering"))
        {
            ...
            ImGui::SameLine();
            HelpMarker("When drawing circle Primitivos with \"num_segments == 0\" tesselation will be calculated automatically.");
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    {
        if (ImGui::BeginTabItem("Primitivos"))
        {
            ...
            // Draw a bunch of Primitivos
            ImGui::Text("All Primitivos");
