...
//TODO !!Place everything on the header and delete the .cpp
//TODO !!ECL (Entity Component Layers) The systems will be the layers and the ECSCoordinator will only query the entitites given a list of required components that will be used in a specific layer (so the class ECSCoordinator must be renamed). Ex: Layer HardPhysics will query all the entities which have minimum the rigidbody and transform coponents. So the Layer is just a rename of the System indeed


//TODO Use an array more than a vector? or a more efficient data structure, slotmap?
//TODO Is correct for DOD avoid inherance and interfaces?
//TODO Is correct for DOD use templates?
//TODO Is correct for DOD use operators overload?
