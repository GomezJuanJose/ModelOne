...
namespace ModelOne {
	...
	public:
		...
		virtual const uint32_t GetColorAttachmentRendererID(uint32_t index = 0) const override { MO_ASSERT(index < m_ColorAttachments.size(), "Index out range"); return m_ColorAttachments[index]; }
