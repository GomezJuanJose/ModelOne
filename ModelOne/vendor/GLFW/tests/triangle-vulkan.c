...
struct demo {
    ...
    struct texture_object textures[DEP_TEXTURE_COUNT];
...
static void demo_prepare_textures(struct demo *demo) {
    ...
    const uint32_t tex_colors[DEP_TEXTURE_COUNT][2] = {
...
static void demo_prepare_descriptor_layout(struct demo *demo) {
    const VkDescriptorSetLayoutBinding layout_binding = {
        ...
        .descriptorCount = DEP_TEXTURE_COUNT,
...
static void demo_prepare_descriptor_set(struct demo *demo) {
    VkDescriptorImageInfo tex_descs[DEP_TEXTURE_COUNT];
    ...
    write.descriptorCount = DEP_TEXTURE_COUNT;
